...
def attackkkk_deck(deck):
    cards_attack =[]
    for i in range(10):
        if deck.xpath('/PlayerConfig/deck/card[attack[.=5]]') != None :
            card = deck.xpath('/PlayerConfig/deck/card[attack[.=5]]')
            cards_attack.append(card)
            i=i+1
        elif deck.xpath('/PlayerConfig/deck/card[attack[.=4]]') != None:
            card = deck.xpath('/PlayerConfig/deck/card[attack[.=4]]')
            cards_attack.append(card)
            i = i + 1
        elif deck.xpath('/PlayerConfig/deck/card[attack[.=3]]') != None:
            card = deck.xpath('/PlayerConfig/deck/card[attack[.=3]]')
            cards_attack.append(card)
            i = i + 1
        elif deck.xpath('/PlayerConfig/deck/card[attack[.=2]]') != None:
            card = deck.xpath('/PlayerConfig/deck/card[attack[.=2]]')
            cards_attack.append(card)
            i = i + 1
        elif deck.xpath('/PlayerConfig/deck/card[attack[.=1]]') != None :
            card = deck.xpath('/PlayerConfig/deck/card[attack[.=1]]')
            cards_attack.append(card)
            i = i + 1
        elif deck.xpath('/PlayerConfig/deck/card[attack[.=0]]') != None:
...
def attack_deck(deck):
    ...
    for i in range(10):
        if deck.xpath('/PlayerConfig/deck/card/attack=5') == True:
            ...
            cards_attack.append(card)
            i=i+1
        elif deck.xpath('/PlayerConfig/deck/card/attack=4') == True:
            card = deck.xpath('/PlayerConfig/deck/card[attack[.=4]]')
            cards_attack.append(card)
            i = i + 1
